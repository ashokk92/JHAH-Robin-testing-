...
WebUI.click(findTestObject('Object Repository/Page_IP Bills/span_Interim Bill'))

WebUI.click(findTestObject('Object Repository/Page_IP Bills/span_Save'))

WebUI.click(findTestObject('Object Repository/Page_IP Bills/span_Print Interim Summary'))

WebUI.click(findTestObject('Object Repository/Page_IP Bills/span_Report_ui-icon ui-icon-closethick'))

WebUI.click(findTestObject('Object Repository/Page_IP Bills/span_Print Interim'))

WebUI.click(findTestObject('Object Repository/Page_IP Bills/span_Report_ui-icon ui-icon-closethick'))

WebUI.click(findTestObject('Object Repository/Page_IP Bills/span_Close'))
