...
WebUI.click(findTestObject('moh sigin/label_'))
...
WebUI.click(findTestObject('Object Repository/moh sigin/a_administrator (King Salman Abdulaziz Hosp_783fa5'))

WebUI.click(findTestObject('Object Repository/moh sigin/a_administrator (King Salman Abdulaziz Hosp_783fa5'))

WebUI.click(findTestObject('Object Repository/moh sigin/button_LOGOUT'))
