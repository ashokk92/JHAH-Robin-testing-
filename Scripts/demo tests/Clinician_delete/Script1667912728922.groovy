...
WebUI.click(findTestObject('Page_/span_Delete'))

WebUI.verifyElementVisible(findTestObject('Page_/div_ConfirmationAre you sureYesNo'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Page_/span_Yes'))
