...
WebUI.click(findTestObject('Object Repository/Page_Refund Receipts/label_All'))

WebUI.click(findTestObject('Object Repository/Page_Refund Receipts/li_Paid'))

WebUI.delay(2)

WebUI.click(findTestObject('Page_Refund Receipts/Element_refund 3'))
...
WebUI.click(findTestObject('Object Repository/Page_Refund Receipts/li_Patient not availed service'))
