...
WebUI.click(findTestObject('IP MergeBill/span_Merge Bill'))

WebUI.setText(findTestObject('IP MergeBill/input_Merge Bill_mergeBillDtlFormitem_input'), 'mrn')

WebUI.doubleClick(findTestObject('IP MergeBill/td_SALMER mhd SALEM'))

WebUI.waitForPageLoad(10)

WebUI.click(findTestObject('IP MergeBill/span_Save'))

WebUI.delay(4)

WebUI.click(findTestObject('IP MergeBill/span_Close'))
