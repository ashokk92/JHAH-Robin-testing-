...
WebUI.click(findTestObject('Object Repository/Page_Advance Collection/td_kjukk 7uytrewq oopkmnhg'))
...
WebUI.click(findTestObject('Page_Advance Collection/Element_add advance 2'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Advance Collection/p_Advance Collection has been created Successfully'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Advance Collection/div_AlertAdvance Collection has been create_77065f'))
