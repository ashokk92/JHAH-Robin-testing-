...
WebUI.click(findTestObject('IP Perdeim/span_Apply perdiem'))

WebUI.click(findTestObject('IP Perdeim/span_ui-button_ui-chkbox-icon ui-icon ui-icon-blank ui-c'))

WebUI.click(findTestObject('IP Perdeim/span_ui-button_ui-button-icon-left ui-icon ui-c fa fa-th-list'))

WebUI.click(findTestObject('IP Perdeim/span_Close'))

WebUI.click(findTestObject('IP Perdeim/span_Apply'))

WebUI.click(findTestObject('IP Perdeim/span_Yes'))
